...
const Contact = () => {
    return (
        <div className='flex flex-wrap pt-20 justify-evenly py-4 border-b-2 border-b-gray-500 bg-[#121212] max-w-screen-2xl mx-auto'>
            <div className='py-20'>
                <h1 className='text-white font-bold text-2xl'>Let's Connects</h1>
                <p className='text-gray-500 text-[17px] '>I'm currently looking for new opportunities,You can connect<br/>
                 with me through github and linkedIn always open. Whether<br/>
                  you have a question or just want to say hi, I'll try my best<br/>
...
<input type="text" placeholder='Just saying hi' className='bg-[#18191E] border-2 border-gray-800 w-[30rem] p-6 mb-6 h-[5%] rounded-md max-sm:w-[10rem]'/>
        ...
        <textarea name="" className='bg-[#18191E] text-gray-400 border-2 border-gray-800 w-[30rem] p-6 mb-6 h-[20%] rounded-md max-sm:w-[10rem]'>Let's talk about..</textarea>
